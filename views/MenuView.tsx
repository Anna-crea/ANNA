...
import { Search, CheckCircle2, Plus, X, Trash2, Heart, Sparkles, Loader2, Wand2, Key, AlertCircle, Share2, Check } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="h-80 md:h-[600px] relative p-10 bg-stone-50 overflow-hidden">
                <div className="w-full h-full rounded-[3rem] overflow-hidden gold-liquid-border shadow-2xl relative bg-stone-200">
                  ...
                  {aiImages[selectedMeal.id] && (
                    <div className="absolute top-8 left-8 bg-amber-600/90 backdrop-blur-md text-white px-5 py-2 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center gap-2 shadow-2xl border border-white/20">
