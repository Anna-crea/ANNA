      ...
      <section className="relative min-h-[90vh] flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white z-10 py-20">
          ...
          <div className="flex flex-col sm:flex-row gap-8">
            ...
            <button className="brilliant-btn bg-white/5 backdrop-blur-md border border-amber-500/20 hover:bg-white/10 text-white px-12 py-6 rounded-2xl font-black text-xs uppercase tracking-widest transition-all">
              Réserver une Loge
            </button>
          </div>
        </div>
